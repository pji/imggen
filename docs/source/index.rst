.. imggen documentation master file, created by
   sphinx-quickstart on Wed Sep 27 08:32:41 2023.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to imggen's documentation!
==================================
...
------------------------------------
Yes, but :mod:`imggen` is not currently available through PyPI. You
