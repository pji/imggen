...
def build_noisy():
    ...
    iw.write('tests/data/__test_noisy_curtains.jpg', a)
    ...
    a = noise.fill((1, 480, 640))
    iw.write('tests/data/__test_noisy_ocoscurtains.jpg', a)

    noise = ig.unitnoise.OctaveCurtains(
        unit=(1, 1024, 1024), seed='spam', repeats=1
    )
    a = noise.fill((1, 480, 640))
    iw.write('tests/data/__test_noisy_ocurtains.jpg', a)

    noise = ig.perlin.OctavePerlin(
        unit=(1, 1024, 1024), seed='spam', repeats=1
    )
    a = noise.fill((1, 480, 640))
    iw.write('tests/data/__test_noisy_operlin.jpg', a)

    noise = ig.unitnoise.OctaveUnitNoise(
        unit=(1, 1024, 1024), seed='spam', repeats=1
    )
    a = noise.fill((1, 480, 640))
    iw.write('tests/data/__test_noisy_ounitnoise.jpg', a)

    noise = ig.worley.OctaveWorley(points=16, seed='spam')
    a = noise.fill((1, 480, 640))
    iw.write('tests/data/__test_noisy_oworley.jpg', a)

    noise = ig.perlin.Perlin(
        unit=(1, 1024, 1024), seed='spam', repeats=1
    )
    a = noise.fill((1, 480, 640))
    iw.write('tests/data/__test_noisy_perlin.jpg', a)
    ...
    a = noise.fill((1, 480, 640))
    iw.write('tests/data/__test_noisy_worley.jpg', a)
