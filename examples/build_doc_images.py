...
def make_patterns(size: ig.Size, path: Path) -> None:
    """Create the example images for :mod:`imggen.patterns`."""
    srcs = [
        ig.Box(
...
def make_random(size: ig.Size, path: Path) -> None:
...
def save(src: ig.Source, size: ig.Size, path: Path, ext: str = 'jpg') -> None:
